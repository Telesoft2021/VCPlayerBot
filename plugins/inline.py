...
buttons = [
    [
        InlineKeyboardButton('Download App 1', url='https://liveokk.com'),
        InlineKeyboardButton('Download App 2', url='https://xuyendem.com/app')
    ],
    [
        InlineKeyboardButton('⚡️ Channel', url='https://t.me/telesoft_channel')
    ],
    ]
def get_cmd(dur):
    if dur:
